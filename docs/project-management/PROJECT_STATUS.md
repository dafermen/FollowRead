...
**Tarea activa:** FR-PH04-TASK-005 - Exponer login, logout y sesión actual  
...
Argon2id, tokens opacos seguros y un comando local idempotente para crear el primer
superadministrador. Continúa la exposición de login, logout y sesión actual.
...
| Tareas de Fase 4 completadas | 4 de 10 |
...
| FollowRead API | PHASE_4_IN_PROGRESS | Persistencia y primitivas de autenticación listas |
...
continuar FR-PH04-TASK-005 con el servicio y las rutas de login, logout y sesión actual.
